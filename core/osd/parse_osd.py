...
def process_dequeue_op_end(words, wops, rops):
    ...
    for ops in [wops, rops]:
        for op in ops.values():
            if "dequeue_thread" in op: ## means it is still in the osd dequeue thread
